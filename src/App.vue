...
<div class="links">
<img class="slidy-img" src='./image/img1.jpg'>
<link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet">
<div class="content1">
  <div class="content1__container1">
    <p class="content1__container1__text">
      Hello
    </p>
    
    <ul class="content1__container1__list">
      <li class="content1__container1__list__item">world !</li>
      <li class="content1__container1__list__item">Anes ! </li>
      <li class="content1__container1__list__item">everybody !</li>
      <li class="content__container1__list__item">Full-Stack JS</li>
    </ul>
  </div>
</div>
  ...
  <ul class="links__list" style="--item-total:5">
    <li class="links__item" style="--item-count:1">
      <a class="links__link" href="#">
        ...
        <span class="links__text">About Me</span>
      </a>
    </li>
    <li class="links__item" style="--item-count:2">
      <a class="links__link" href="#">
        ...
        <span class="links__text">Measure</span></a>
    </li>
    <li class="links__item" style="--item-count:3">
      <a class="links__link" href="#">
        ...
        <span class="links__text">Technologie</span></a>
    </li>
...
.content1__container1 {
  font-weight: 600;
  overflow: hidden;
  height: 40px;
  padding: 0 20px;
}
.content1__container1:before {
  content: '[';
  left: 0;
}
.content1__container1:after {
  content: ']';
  position: absolute;
  right: 0;
}
.content1__container1:after, .content1__container1:before {
  position: absolute;
  top: 0;
  color: #16a085;
  font-size: 42px;
...
.content1__container1__text {
  display: inline;
  float: left;
  margin: 0;
}
.content1__container1__list {
  margin-top: 0;
  padding-left: 110px;
  text-align: left;
  list-style: none;
...
.content1__container1__list__item {
  line-height: 40px;
  margin: 0;
}
...
body {
  background-color:rgb(51,60,72) ;
  background: linear-gradient(90deg, rgb(207,175,168) 0%,rgb(108,51,60) 35%,rgb(71,30,34) 100%);
